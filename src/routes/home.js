...
import animated1 from "../assets/images/animated1.gif";
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col ">
      <section className="pt-[5rem]	 bg-gray-100 flex justify-center	items-center p	">
        <div>
          <div className="flex flex-col items-center w-[82rem] md:flex-row">
            ...
            {user ? (
              <img
                className="w-[43rem] mix-blend-multiply	"
                src={animated1}
                alt="dwfew"
              />
            ) : (
      ...
      <section className="pb-[4rem] bg-gray-100 flex justify-center	items-center	">
      ...
      <footer aria-label="Site Footer" className="bg-white dark:bg-gray-900">
        <div className="mx-auto max-w-screen-xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex-col">
            <div className="mt-8 flex flex-col gap-[4rem] ">
